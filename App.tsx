...
import { View, Modal, TouchableOpacity, Text, StyleSheet, PanResponder, Switch } from 'react-native';

const BottomSheet = ({ visible, onClose }) => {
  const [sheetHeight, setSheetHeight] = useState(300); // Initial height of the bottom sheet
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderMove: (event, gestureState) => {
      if (isDragging) {
        ...
        if (newHeight >= 150) {
          // Limiting the minimum height of the bottom sheet
